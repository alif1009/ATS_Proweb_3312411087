...
<body class="bg-white font-[Comic Sans MS]">
    ...
    <div class="flex items-center justify-between p-4 border-b-2 border-blue-400 shadow">
        <a href="{{ url('/') }}"
            class="flex items-center space-x-2 border border-black px-3 py-1 rounded-md text-black hover:bg-gray-100">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 transform rotate-180" fill="none" viewBox="0 0 24 24"
                stroke="currentColor">
        ...
        <div class="bg-gray-200 p-6 rounded-2xl shadow-lg w-full max-w-md">
            <div class="flex flex-col items-center">
                ...
                <img src="{{ asset('images/profile.jpg') }}" alt="profile"
                    class="w-24 h-24 rounded-full shadow-md mb-2 object-cover">
            </div>
            ...
            <form id="editForm" class="hidden mt-6 space-y-4">
                <input type="text" id="username" placeholder="Username" class="w-full px-4 py-2 rounded border"
                    required>
                <input type="text" id="nama" placeholder="Nama Lengkap" class="w-full px-4 py-2 rounded border"
                    required>
            ...
            <div id="editButtonContainer" class="mt-6 flex justify-start">
                <button onclick="ubahProfil()"
                    class="px-6 py-1 rounded-full border border-black font-semibold hover:bg-gray-100">Ubah</button>
            </div>
        </div>
    </div>
