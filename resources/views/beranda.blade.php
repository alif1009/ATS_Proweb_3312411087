        ...
        <div class="flex-1 flex justify-center space-x-8">
            <div x-data="{ open: false }" class="relative flex items-center space-x-2">
                ...
                <div x-show="open" @click.away="open = false" x-transition
                    ...
                    <a href="#" class="block px-4 py-2 text-sm text-black hover:bg-gray-100">Bazar Preloved</a>
                    <a href="#" class="block px-4 py-2 text-sm text-black hover:bg-gray-100">Bazar Makanan</a>
                    <a href="#}" class="block px-4 py-2 text-sm text-black hover:bg-gray-100">Seminar Mentality</a>
                    <a href="#" class="block px-4 py-2 text-sm text-black hover:bg-gray-100">Seminar Informatika</a>
                    <a href="#" class="block px-4 py-2 text-sm text-black hover:bg-gray-100">Festival Budaya</a>
