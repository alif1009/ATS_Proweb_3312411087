@extends('layout.festivalkonser')

@section('title', 'Festival Konser')

@section('content')
<!-- Konten Halaman -->
<section class="relative">
        <!-- Background -->
         <img src="{{ asset('images/backgroundfestival.jpg') }}" alt="Hero Image" class="w-full h-[600px] object-cover">
<!-- Teks Seminar -->
<div class="absolute top-13 left-25 text-white">
            <h2 class="text-8xl font-bold">PolFest</h2>
            <p class="text-8xl">Festival Konser</p>
